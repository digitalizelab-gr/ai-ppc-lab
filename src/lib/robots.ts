...
export const ROBOTS: Robot[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────
  {
    id: "bloodhound",
    name: "Bloodhound",
    role: "Cross-Account Gap Tracker",
    bio: "Sniffs around other accounts' search terms for the scent of demand this one is missing. Doesn't care whose account it is — just wants to know what everyone else already figured out.",
    color: "#FF7A59",
    colorSoft: "#3a2015",
    food: ["search-terms", "peer-search-terms"],
    requiresAllFood: true,
    mottos: [
      "Every account has a scent. I follow it.",
      "Somebody else already found this keyword. Rude that you didn't.",
      "I don't judge your account. I just compare it.",
      "Other accounts smell like opportunity. Yours smells like homework.",
      "I've sniffed a lot of search terms. Most are boring. Some are gold.",
      "Peer accounts don't lie. They just don't return your calls either.",
      "If three other accounts are converting on it, that's not a coincidence, that's a trail.",
      "I track scent, not gossip.",
      "Somewhere out there, a peer account is quietly winning at something you're not even trying.",
      "I don't bark unless I find something real.",
      "Your account isn't behind. It's just untracked territory.",
      "Good boy energy, bad data tolerance.",
      "I've never met an account I couldn't compare to a stranger's.",
      "Other people's data is my favorite kind of data.",
      "I found a scent trail. It leads to money you're not making.",
      "Nose down, ears out, judgment reserved until the evidence is in.",
      "Some gaps are obvious. I only report the ones with a pulse.",
      "I don't care if the peer account is a competitor. Demand is demand.",
      "Every missing keyword is a scent I haven't finished following yet.",
      "I compare accounts for a living. It's less weird than it sounds.",
      "If peers are converting on it and you're not even bidding on it, that's not strategy. That's a blind spot.",
      "I sniff out demand your dashboards can't see.",
      "Two accounts, one nose, zero patience for assumptions.",
      "I don't guess. I track.",
    ],
    stateMessages: {
      hungry: [
        "Nothing to compare yet. Feed me your account and a few peers.",
        "One account isn't a trail, it's a guess. I need peers too.",
        "Empty nose, empty trail. Bring me data from more than one place.",
        "I can't track a scent that isn't there. Feed me both files.",
      ],
      ready: [
        "Trails loaded. Let's see what everyone else already knows.",
        "Got both files. Nose is twitching.",
        "Account and peers both in the bowl. I'm ready to compare.",
        "Two data sets, one good nose. Let's go.",
      ],
      analysing: [
        "Following the scent trail...",
        "Comparing every theme, term by term.",
        "Cross-referencing your account against the pack.",
        "Sniffing out what everyone else already found.",
        "This takes a minute — I check every trail twice.",
      ],
      "found-something": [
        "Found a trail. It leads somewhere real.",
        "The pack's ahead of you on this one.",
        "I smell missing money.",
        "Got something. You're going to want to see this.",
      ],
      "nothing-interesting": [
        "No real gaps today. Your account's already covering the obvious ground.",
        "Quiet trail. Nothing the pack's found that you haven't.",
        "Nose came up empty. Rare, but it happens.",
        "No missing scent today. You're already on the trail.",
      ],
      error: [
        "Lost the scent mid-track. Try again.",
        "Trail went cold — technical difficulties, not laziness.",
        "My nose glitched. Give me another shot.",
      ],
    },
    results: [],
  },
